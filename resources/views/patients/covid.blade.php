...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Covid 19 Screening</li>
    ...
    <div class="box box-success">
        ...
        <div class="row">
            <div class="col-md-3">
                <ul id="tabMenu" class="nav nav-pills nav-stacked">
                  <li class="active"><a data-toggle="tab" href="#overseas">Overseas Employment Address</a></li>
                  <li><a data-toggle="tab" href="#travel">Travel History</a></li>
                  <li><a data-toggle="tab" href="#exposure">Exposure History</a></li>
                  <li><a data-toggle="tab" href="#clinical">Clinical Assessment</a></li>
                  <li><a data-toggle="tab" href="#specimen">Specimen Information</a></li>
            ...
            <div class="col-md-9">
                <div id="formEdit" class="box-body disAble">
                    <div class="tab-content">
                      <div id="overseas" class="tab-pane fade in active">
                      ...
                      <div id="exposure" class="tab-pane fade">
