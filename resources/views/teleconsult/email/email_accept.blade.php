                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                      <td valign="top" class="textContent">
                                        ...
                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">This will inform you that your teleconsultation for patient <b>{{$patient}}</b> will be on <b>{{$date}}</b>.</div>
                                        <div>Chief Complaint: <b>{{$complaint}}</b></div>
                                        <div>Doctor: <b>{{$doctor}}</b></div>
