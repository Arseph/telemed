<form id="patient_form" class="disAble">
    ...
    <div class="col-sm-12">
     ...
     <div class="col-sm-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="@if($patient->patient){{\Crypt::decrypt($patient->patient->fname)}}@else{{\Crypt::decrypt($patient->fname)}}@endif" name="fname" required>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            <label>Middle Name:</label>
            <input type="text" class="form-control" value="@if($patient->patient){{\Crypt::decrypt($patient->patient->mname)}}@else{{\Crypt::decrypt($patient->mname)}}@endif" name="mname">
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            <label class="reqField">Last Name:</label>
            <input type="text" class="form-control" value="@if($patient->patient){{\Crypt::decrypt($patient->patient->lname)}}@else{{\Crypt::decrypt($patient->lname)}}@endif" name="lname" required>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            <label class="reqField">Contact Number:</label>
            <input type="text" class="form-control" value="@if($patient->patient){{\Crypt::decrypt($patient->patient->contact)}}@else{{\Crypt::decrypt($patient->contact)}}@endif" name="contact" required>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <select class="form-control sex" name="sex" required>
                <option value="@if($patient->patient){{\Crypt::decrypt($patient->patient->sex)}}@else{{\Crypt::decrypt($patient->sex)}}@endif" selected>@if($patient->patient){{\Crypt::decrypt($patient->patient->sex)}}@else{{\Crypt::decrypt($patient->sex)}}@endif</option>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <select class="form-control civil_status" name="civil_status" required>
                <option value="@if($patient->patient){{\Crypt::decrypt($patient->patient->civil_status)}}@else{{\Crypt::decrypt($patient->civil_status)}}@endif" selected>@if($patient->patient){{\Crypt::decrypt($patient->patient->civil_status)}}@else{{\Crypt::decrypt($patient->civil_status)}}@endif</option>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="@if($patient->patient){{\Crypt::decrypt($patient->patient->house_no)}}@else{{\Crypt::decrypt($patient->house_no)}}@endif" name="house_no">
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            <label>Street:</label>
            <input type="text" class="form-control" value="@if($patient->patient){{\Crypt::decrypt($patient->patient->street)}}@else{{\Crypt::decrypt($patient->street)}}@endif" name="street">
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
    ...
    <div class="col-sm-12">
        <div class="has-group others_holder">
            ...
            <input type="text" name="address" value="@if($patient->patient){{\Crypt::decrypt($patient->patient->address)}}@else{{\Crypt::decrypt($patient->address)}}@endif" class="form-control others" placeholder="Enter complete address..." />
        </div>
    </div>
 </div>
</form>